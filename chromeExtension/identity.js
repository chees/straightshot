var googlePlusUserLoader = (function() {
  ...
  return {
    onload: function () {
      ...
      //xhrWithAuth('GET', 'http://localhost:8080/secure', false, function(error, status, response) {
      xhrWithAuth('GET', 'https://straightshot42.appspot.com/secure', false, function(error, status, response) {
